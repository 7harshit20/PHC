                        ...
                        <div className="modal-body">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input onChange={onChange} required={true} name="email" class="form-control" id="inputemail" type="email" placeholder="Your e-mail" />
                                </div>

                                <div class="row gx-6 mb-3">
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputRollno">Rollno</label>
                                        <input onChange={onChange} required={true} name="roll_number" class="form-control" id="inputRollno" type="text" placeholder="Enter your Rollno" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputName">Name</label>
                                        <input onChange={onChange} required={true} name="name" class="form-control" id="inputName" type="text" placeholder="Enter your Name" />
                                    </div>
                                </div>
                                <div class="row gx-3 mt-3 mb-3">
                                    <div class="col-md-2">
                                        <label class="small mb-1" for="inputGender">Gender</label>
                                        <select onChange={onChange} required={true} name="gender" class="form-select" aria-label="Select Your Gender">
                                            <option>Male</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input onChange={onChange} required={true} name="birth" class="form-control" id="inputBirthday" type="date" placeholder="Enter your birth date" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputPhone">Phone number</label>
                                        <input onChange={onChange} required={true} name="phone" class="form-control" id="inputPhone" type="integer" placeholder="Enter your phone number" />
                                    </div>
                                </div>
                                <div class="row gx-3 mt-3 mb-3">
